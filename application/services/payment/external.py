...
class CeibaPaymentGateway(BasePaymentGateway):
    def __init__(self, repeat=0):
        super(CeibaPaymentGateway, self).__init__(repeat)
        self.gateway = "CeibaPaymentGateway"

    def __repr__(self):
        return "<CeibaPaymentGateway>"
...
class ExternalPayment:
    ...
    def make_payment(self):
        try:
            payment_mode = None
            if self.amount <= 20:
                payment_mode = CeibaPaymentGateway()
